...
class ProgrammingLanguage:
    """Represent information about a programming language, including typing, reflection, pointer arithmetic, and year"""
    ...
    def __str__(self):
        """Return string representation to users."""
        return (f"{self.name}, Typing: {self.typing}, Reflection: {'Yes' if self.reflection else 'No'}, "
                f"Pointer Arithmetic: {'Yes' if self.pointer_arithmetic else 'No'}, Year: {self.year}")
